...
export abstract class Schedule {
  ...
  /**
   * The IANA time zone for this schedule.
   *
   * @default - undefined (UTC)
   */
...
export interface CronOptions {
  ...
  /**
   * The IANA time zone to use for the cron schedule.
   *
   * When provided, the schedule will use this time zone instead of UTC.
   *
