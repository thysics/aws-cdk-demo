...
describe('bucket', () => {
  ...
  test('bucket with intelligent tiering using tierings array with multiple tiers', () => {
    const stack = new cdk.Stack();
    new s3.Bucket(stack, 'MyBucket', {
      intelligentTieringConfigurations: [{
        name: 'foo',
  ...
  test('bucket with intelligent tiering combining tierings array and archiveAccessTierTime', () => {
    const stack = new cdk.Stack();
    new s3.Bucket(stack, 'MyBucket', {
      intelligentTieringConfigurations: [{
        name: 'foo',
