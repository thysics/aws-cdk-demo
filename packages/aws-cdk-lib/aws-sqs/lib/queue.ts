...
export interface QueueProps {
  ...
  /**
   * Specifies whether to enable high throughput for FIFO queues.
   *
   * When set to true, this automatically sets `deduplicationScope` to
   * `DeduplicationScope.MESSAGE_GROUP` and `fifoThroughputLimit` to
